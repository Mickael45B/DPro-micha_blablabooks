...
import { CREATE_BOOK, UPDATE_BOOK, DELETE_BOOK } from '../../../../data/graphql/queries/queriesBooks.jsx';
			...
			<div className="carousel-track">
				{randomBooks.map((book) => (
					...
					>
						...
						{(() => {
							const raw = book?.vignetteimage || '';
							const fileName = raw.endsWith('.png') || raw.endsWith('.jpg') || raw.endsWith('.jpeg')
								? raw
								: `${raw}.png`;
							const src = `/images/vignettesImages/${fileName}`; 
							return (
								<img
									src={src}
